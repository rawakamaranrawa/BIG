...
def tik():
    titik = ['.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;93mtkaya bosta \x1b[1;93m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def menu():
    os.system('clear')
    print logo
    print '\x1b[1;97m[1]\x1b[1;97m  bo xaty nawroz'
    print '\x1b[1;97m[2]\x1b[1;97m  bo xaty asiacell'
    print '\x1b[1;97m[3]\x1b[1;97m  no xaty korak'
    print '\x1b[1;97m[4]\x1b[1;97m  bo xaty tp link'
    print '\x1b[1;97m[5]\x1b[1;97m  bo hamu xatyk abyt \033[92m[No CP] \033[97m'
    print '\n\x1b[1;97m[0]  darchon           '
    print '\x1b[1;97m--------------------------------------------------\n'
    action()
...
def action():
    ...
    if peak == '':
        ...
        action()
    xxx = str(len(id))
    psb('[\xe2\x9c\x93] ڕەقەمێک بنووسە: ' + xxx)
    time.sleep(0.5)
    psb('[\xe2\x9c\x93] کڕاک دەستی پێکرد')
    time.sleep(0.5)
    psb('[\xe2\x9c\x93] Trying Passwords Wait...')
    time.sleep(0.5)
    psb('[!] bo wastandan CTRL Then Press z dagra')
    time.sleep(0.5)
    print '\x1b[1;97m--------------------------------------------------'
    ...
    p.map(main, id)
    print '\x1b[1;97m--------------------------------------------------'
    print '[\xe2\x9c\x93] کڕاک تەواو بوو ...'
